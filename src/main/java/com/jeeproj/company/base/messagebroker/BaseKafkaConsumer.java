...
public abstract class BaseKafkaConsumer<T> {
    protected final Class<? extends BaseDeserializer<T>> deserializerClass;
    ...
    protected Properties getConsumerProperties() {
        ...
        consumerProperties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, deserializerClass.getName());
